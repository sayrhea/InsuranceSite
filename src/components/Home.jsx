    ...
    <div className="relative mt-40">
      <main className="flex lg:flex-row flex-col justify-between mx-20 my-10 lg:h-[95vh]">
        <div className="text-section lg:w-[50%] py-[5%]">
          <h1 className="lg:text-7xl text-5xl font-[400px] leading-[1.2]">
            Insurance
            <br />
            Coverage You
            <br /> Can Count On
          </h1>
          <p className="lg:text-2xl text-xl my-5 pb-10 text-gray-600">
            Wherever and whenever you need.
            <br /> It's our job to protect you and what matters to
            <br /> you most.
          </p>
          <button className="bg-gray-800 text-white px-6 py-4 text-lg rounded-full hover:bg-green-800">
            Contact Us
          </button>
        </div>
        <div
          ...
          <div className="home-img-div home-img-row-3  flex curosor-pointer">
            <div className="left-[0] h-[200px] w-[200px]">
              <img
                src="/home-img4.jpg"
                alt="family"
                className="rounded-tl-[0] rounded-br-[0] rounded-tr-[0] rounded-bl-[60%]"
              />
            </div>
